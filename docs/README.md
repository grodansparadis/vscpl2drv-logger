...
- VSCP string format (text).
- XML format.
- JSON format.

The advantage of using JSON format is that it can be read by VSCP works and further analyzed in the tool. Several drivers can be used to write logging data to different output files and using different filter/masks for complex logging.
